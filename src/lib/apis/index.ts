...
export const chatCompleted = async (token: string, body: ChatCompletedForm) => {
	// Static implementation - just return success
	console.log('✅ Static chatCompleted called with:', body);
	return {
		status: 'success',
...
export const chatAction = async (token: string, action_id: string, body: ChatActionForm) => {
	// Static implementation - just return success
	console.log('✅ Static chatAction called with:', { action_id, body });
	return {
		status: 'success',
		action_id: action_id,
...
export const generateQueries = async (
	...
	// Static implementation - return empty queries array
	console.log('✅ Static generateQueries called with:', { model, prompt, type });
	return [];
};
...
export const generateMoACompletion = async (
	...
	// Static implementation - return mock response and controller
	console.log('✅ Static generateMoACompletion called with:', { model, prompt, responses });

	const controller = new AbortController();
	const mockResponse = new Response('', { status: 200 });

	return [mockResponse, controller];
};
