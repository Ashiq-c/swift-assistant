			...
			if (file['type'].startsWith('image/')) {
				...
				reader.readAsDataURL(
					file['type'] === 'image/heic'
						? await (await import('heic2any')).default({ blob: file, toType: 'image/jpeg' })
						: file
				);
			} else {
			...
			>
				<div class="">
					...
					{:else}
						...
						>
							<div
								class="flex-1 flex flex-col relative w-full rounded-2xl border border-gray-200 hover:border-gray-300 transition px-4 py-3 bg-white"
							...
							>
								...
								<div class="flex items-center justify-between px-2 py-2" dir="ltr">
									<div class="flex items-center gap-2">
										...
										>
											<div class="text-gray-500 hover:text-gray-700 transition rounded-full p-1.5">
												<svg
													xmlns="http://www.w3.org/2000/svg"
													viewBox="0 0 20 20"
													aria-hidden="true"
